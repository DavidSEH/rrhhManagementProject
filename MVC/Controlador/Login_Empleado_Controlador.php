        ...
        if (isset($_POST['Acceso'])) {
            if (empty($_POST['usuario']) || empty($_POST['clave'])) {
                ...
                if ($_POST['g-recaptcha-response'] == '') {
                    ...
                    $query = mysqli_query($conection, "SELECT * FROM usuario WHERE usuario = '$user' AND clave = '$pass' AND ID_ROL = 2");
                    ...
                    if ($result > 0) {
                        ...
                        if ($data['estado'] != 0) {
                            ...
                            $alert = '<div class="alertLogin">El usuario esta desactivado. Contacta con un administrador</div>';
                            session_destroy();
                        }
                    } else {
