            ...
            <section>
                ...
                <div class="seccion-user ">
                    ...
                    $query = mysqli_query($conection,"SELECT u.idusuario,u.dni, u.nombre,u.edad, u.correo,u.telefono,
                                        ...
                                        WHERE estatus = 1 ORDER BY u.idusuario ");
                    ...
                    ?>
                       ...
                       <div class="lista-p" >
                            ...
                            <div class="lista-btn">
                                ...
                                <a href="EliminarUsuario.php?id=<?php echo $data["idusuario"]; ?>" 
                                    class="btn-delete"><i class="fas fa-level-down-alt"></i> Descender</a>
                                <?php } ?>
                               <a href="ModificarUsuario.php?id=<?php echo $data["idusuario"]; ?> " 
                                    class="btn-update"><i class="fas fa-edit"></i>Modificar</a>
                            </div>
                       </div> 
                    <?php 
                            }
