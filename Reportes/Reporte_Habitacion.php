<?php 
    ...
    if(empty($_REQUEST['idUser']))
	{
        ...
        $query_habitacion= mysqli_query($conection,
                                    "SELECT h.idhabitacion,h.num_habitacion,h.descripcion,
        ...
        $result = mysqli_num_rows($query_habitacion);
        ...
        $pdf->Cell(195,10," Reporte de Licencias",1,1,"C",2);
        ...
        $pdf->SetTextColor(255,255,255);
        $pdf->SetFillColor(41,165,161);
        $pdf->Cell(30,12,utf8_decode("N° Licencia"),1,0,"C",1);
        $pdf->Cell(75,12,"Detalle",1,0,"C",1);
        $pdf->Cell(20,12,"Prioridad",1,0,"C",1);
        $pdf->Cell(20,12,"Precio",1,0,"C",1);
        $pdf->Cell(25,12,"Categoria ",1,0,"C",1);
        ...
        $porcentaje=0;
        if ($result>0) {
            while ($data=mysqli_fetch_array($query_habitacion)) {
                ...
                if ($data['estatus']==2) {
                    ...
                    $pdf->Cell(30,12,$data['num_habitacion'],1,0,"C",1);
                    $pdf->Cell(75,12,$data['descripcion'],1,0,"C",1);
                    $pdf->Cell(20,12,$data['piso'].utf8_decode("°"),1,0,"C",1);
                    $pdf->Cell(20,12,"S/.".$data['precio'],1,0,"C",1);
                    $pdf->Cell(25,12,$data['categoria'],1,0,"C",1);
                    $pdf->Cell(30,12,$msg,1,1,"C",1);
